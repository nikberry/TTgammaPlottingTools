...
void Photons::allPlots(AllSamples samples){
	...
	Variable photon_chargediso_barrel("Photon_PFChargedHadronIso_barrel", "PFChargedHadronIso(barrel)", 0., 20., 2);
	Variable photon_chargediso_endcap("Photon_PFChargedHadronIso_endcap", "PFChargedHadronIso(endcap)", 0., 20., 2);
	Variable photon_rhocorrneutraliso_barrel("Photon_RhoCorrectedPFNeutralHadronIso_barrel", "RhoCorrPFNeutralHadronIso(barrel)", 0., 20., 2);
	Variable photon_rhocorrneutraliso_endcap("Photon_RhoCorrectedPFNeutralHadronIso_endcap", "RhoCorrPFNeutralHadronIso(endcap)", 0., 20., 2);	
	Variable photon_neutraliso_barrel("Photon_PFNeutralHadronIso_barrel", "PFNeutralHadronIso(barrel)", 0., 20., 2);
	Variable photon_neutraliso_endcap("Photon_PFNeutralHadronIso_endcap", "PFNeutralHadronIso(endcap)", 0., 20., 2);   
	Variable photon_rhocorrphotoniso_barrel("Photon_RhoCorrectedPFPhotonIso_barrel", "RhoCorrPFPhotonIso(barrel)", 0., 20., 2);
	Variable photon_rhocorrphotoniso_endcap("Photon_RhoCorrectedPFPhotonIso_endcap", "RhoCorrPFPhotonIso(endcap)", 0., 20., 2);
	Variable photon_photoniso_barrel("Photon_PFPhotonIso_barrel", "PFPhotonIso(barrel)", 0., 20., 2);
	Variable photon_photoniso_endcap("Photon_PFPhotonIso_endcap", "PFPhotonIso(endcap)", 0., 20., 2);
	Variable photon_htowoe("Photon_HtowoE", "H/E", 0., 0.05, 2);
	...
	Variable photon_SCFRChIso("Photon_SCChIso", "SCFR Charged Hadron Iso.", 0, 20, 2);
	Variable photon_SCFRNuIso("Photon_SCNuIso", "SCFR Neutral Hadron Iso.", 0, 35, 2);
	Variable photon_SCFRPhIso("Photon_SCPhIso", "SCFR Photon Iso.", 0, 130, 2);
	Variable photon_rhoCorrSCFRChIso_endcap("Photon_RhoCorrectedSCChIso_endcap", "(#rho-corr) SCFR Charged Hadron Iso. (endcap)", 0, 20, 10);
	Variable photon_rhoCorrSCFRNuIso_endcap("Photon_RhoCorrectedSCNuIso_endcap", "(#rho-corr) SCFR Neutral Hadron Iso. (endcap)", 0, 20, 1);
	Variable photon_rhoCorrSCFRPhIso_endcap("Photon_RhoCorrectedSCPhIso_endcap", "(#rho-corr) SCFR Photon Iso. (endcap)", 0, 20, 1);
	Variable photon_rhoCorrSCFRChIso_barrel("Photon_RhoCorrectedSCChIso_barrel", "(#rho-corr) SCFR Charged Hadron Iso. (barrel)", 0, 20, 10);
	Variable photon_rhoCorrSCFRNuIso_barrel("Photon_RhoCorrectedSCNuIso_barrel", "(#rho-corr) SCFR Neutral Hadron Iso. (barrel)", 0, 20, 1);
	Variable photon_rhoCorrSCFRPhIso_barrel("Photon_RhoCorrectedSCPhIso_barrel", "(#rho-corr) SCFR Photon Iso. (barrel)", 0, 20, 1);
	Variable photon_rhoCorrSCFRChIso("Photon_RhoCorrectedSCChIso", "(#rho-corr) SCFR Charged Hadron Iso.", 0, 20, 10);
	Variable photon_rhoCorrSCFRNuIso("Photon_RhoCorrectedSCNuIso", "(#rho-corr) SCFR Neutral Hadron Iso.", 0, 20, 1);
	Variable photon_rhoCorrSCFRPhIso("Photon_RhoCorrectedSCPhIso", "(#rho-corr) SCFR Photon Iso.", 0, 20, 1);
	Variable photon_RandConeChIso("Photon_RandConeChIso", "Random Cone Iso_{Ch.had}", 0, 20, 1);
	Variable photon_RandConeNuIso("Photon_RandConeNuIso", "Random Cone Iso_{Nu.had}", 0, 20, 1);
	Variable photon_RandConePhIso("Photon_RandConePhIso", "Random Cone Iso_{#gamma}", 0, 20, 1);
	Variable photon_RandConeChIso_barrel("Photon_RandConeChIso_barrel", "Random Cone Iso_{Ch.had} (barrel)", 0, 20, 2);
	Variable photon_RandConeNuIso_barrel("Photon_RandConeNuIso_barrel", "Random Cone Iso_{Nu.had} (barrel)", 0, 20, 1);
	Variable photon_RandConePhIso_barrel("Photon_RandConePhIso_barrel", "Random Cone Iso_{#gamma} (barrel)", 0, 20, 1);
	...
	Variable photon_background("Photon_background", "#sigmai#etai#eta(barrel)", 0., 0.03, 4);
...
// 	photon_rhoCorrSCFRPhIso_barrel.rebinFact *= 2;
	...
	setPhotonSel("AllPhotonsPreSelection");
	setChannel("MuMu");
	savePlot(samples, photon_pt);
	savePlot(samples, photon_eta);
	savePlot(samples, photon_abseta);
...
//	photon_sigmaietaieta_endcap.rebinFact *= 2;
	...
	savePlot(samples, photon_deltaRgammaJets);
	savePlot(samples, photon_deltaRgammaMuons);
	savePlot(samples, photon_background);
...
//	photon_sigmaietaieta_endcap.rebinFact *= 2;
	...
	setSelectionAndChannel("TTbarSingleLeptonAnalysis", "MuMu");
	setPhotonSel("SignalPhotons");
	savePlot(samples, photon_pt);
	savePlot(samples, photon_eta);
	savePlot(samples, photon_abseta);
